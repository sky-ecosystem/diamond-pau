...
import { IParameterErrors }     from "./IParameterErrors.sol";

/**
 * @title  Interface for a Parameter Registry.
 * @notice A parameter registry allows admins to set parameters, including whether an account is an
 *         admin, and allows any account/contract to query the values of parameters.
 */
interface IParameterRegistry is IParameterKeysErrors, IParameterErrors {
