...
library AaveLib {
        ...
        external
    {
        ...
        require(maxSlippages[aToken] != 0, "AaveLib/max-slippage-not-set");
        ...
        require(newATokens >= amount * maxSlippages[aToken] / 1e18, "AaveLib/slippage-too-high");
    }

    function withdraw(address proxy, address rateLimits, address aToken, uint256 amount)
        external
