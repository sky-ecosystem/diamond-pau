...
function makeAddressAddressAddressKey(bytes32 key, address a, address b, address c)
    pure
    returns (bytes32)
{
...
function makeAddressAddressUint256Key(bytes32 key, address a, address b, uint256 c)
    pure
    returns (bytes32)
{
    return keccak256(abi.encode(key, a, b, c));
...
function makeAddressUint16AddressKey(bytes32 key, address a, uint16 b, address c)
    pure
    returns (bytes32)
{
    return keccak256(abi.encode(key, a, b, c));
...
function makeAddressAddressBytes32Uint32Key(bytes32 key, address a, address b, bytes32 c, uint32 d)
    pure
    returns (bytes32)
{
