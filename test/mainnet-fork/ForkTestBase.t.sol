...
abstract contract ForkTestBase is DssTest {
    ...
    function setUp() public virtual {
        ...
        registry = new PAURegistry(Ethereum.SPARK_PROXY, Ethereum.SPARK_PROXY);
        factory  = new PAUFactory(Ethereum.SPARK_PROXY, address(registry));
    ...
    function _wireCCTPFacet() internal {
        ...
        registry.registerFacet("CCTPFacet", cctpFacet);
    ...
    function _wireDAIUSDSFacet() internal {
        ...
        registry.registerFacet("DAIUSDSFacet", daiUSDSFacet);
        ...
        _addWirings(wires, "DAIUSDSFacet");
    }
    ...
    function _wireFarmFacet() internal {
        ...
        registry.registerFacet("FarmFacet", farmFacet);
    ...
    function _wireLayerZeroFacet() internal {
        ...
        registry.registerFacet("LayerZeroFacet", layerZeroFacet);
    ...
    function _wireOTCFacet() internal {
        ...
        registry.registerFacet("OTCFacet", otcFacet);

        IPAURegistry.Wire[] memory wires = new IPAURegistry.Wire[](11);
    ...
    function _wirePSMFacet() internal {
        ...
        registry.registerFacet("PSMFacet", psmFacet);
    ...
    function _wireMapleFacet() internal {
        ...
        registry.registerFacet("MapleFacet", mapleFacet);

        IPAURegistry.Wire[] memory wires = new IPAURegistry.Wire[](3);
    ...
    function _wireSuperstateFacet() internal {
        ...
        registry.registerFacet("SuperstateFacet", superstateFacet);
        ...
        _addWirings(wires, "SuperstateFacet");
    }
    ...
    function _wireWEETHFacet() internal {
        ...
        registry.registerFacet("WEETHFacet", weethFacet);

        IPAURegistry.Wire[] memory wires = new IPAURegistry.Wire[](5);
    ...
    function _wireWSTETHFacet() internal {
        ...
        registry.registerFacet("WSTETHFacet", wstethFacet);
    ...
    function _wireUSDEFacet() internal {
        ...
        registry.registerFacet("USDEFacet", usdeFacet);

        IPAURegistry.Wire[] memory wires = new IPAURegistry.Wire[](10);
    ...
    function _wireWrapProxyETHFacet() internal {
        ...
        registry.registerFacet("WrapProxyETHFacet", wrapProxyETHFacet);
    ...
    function _wireUSDSFacet() internal {
        ...
        registry.registerFacet("USDSFacet", usdsFacet);
    ...
    function _wireUniswapV4Facet() internal {
        ...
        registry.registerFacet("UniswapV4Facet", uniswapV4Facet);
