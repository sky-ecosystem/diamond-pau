...
abstract contract ForkTestBase is Test {
    ...
    function _wireCurveFacet() internal {
        ...
        wires[9] = IEnumerableIntegrations.Wire(
            IForeignControllerFull.CURVE_FACET_VERSION.selector,
    ...
    function _wireMerklFacet() internal {
        ...
        merklWires[2] = IEnumerableIntegrations.Wire(
            IForeignControllerFull.MERKL_FACET_VERSION.selector,
            IFacet.VERSION.selector
        );
    ...
    function _wirePendleFacet() internal {
        ...
        wires[2] = IEnumerableIntegrations.Wire(
            IForeignControllerFull.PENDLE_FACET_VERSION.selector,
            IFacet.VERSION.selector
        );

        wires[3] = IEnumerableIntegrations.Wire(
            IForeignControllerFull.pendleRouter.selector,
    ...
    function _wireAaveFacet() internal {
        ...
        wires[6] = IEnumerableIntegrations.Wire(
            IForeignControllerFull.AAVE_FACET_VERSION.selector,
            IFacet.VERSION.selector
        );
    ...
    function _wireERC4626Facet() internal {
        ...
        wires[8] = IEnumerableIntegrations.Wire(
            IForeignControllerFull.ERC4626_FACET_VERSION.selector,
            IFacet.VERSION.selector
        );
    ...
    function _wireSparkVaultFacet() internal {
        ...
        wires[2] = IEnumerableIntegrations.Wire(
            IForeignControllerFull.SPARK_VAULT_FACET_VERSION.selector,
            IFacet.VERSION.selector
        );
    ...
    function _wireTransferAssetFacet() internal {
        ...
        wires[2] = IEnumerableIntegrations.Wire(
            IForeignControllerFull.TRANSFER_ASSET_FACET_VERSION.selector,
            IFacet.VERSION.selector
        );
    ...
    function _wirePSM3Facet() internal {
        ...
        wires[4] = IEnumerableIntegrations.Wire(
            IForeignControllerFull.PSM3_FACET_VERSION.selector,
            IFacet.VERSION.selector
        );

        wires[5] = IEnumerableIntegrations.Wire(
            IForeignControllerFull.psm3.selector,
